...
The original OkCupid dataset was 59,946 observations with 31 variables. The data also included user characteristics: age-dev, which ranged from 22 to 38 in integers; status, indicating single or available; sex, m/f; and orientation, straight. Physical attributes would be recorded as body type, such as 'a little extra', 'average', 'thin', and height in inches, ranging from 65-71 inches. Lifestyle choices were marked by diet, such as 'strictly anything', 'mostly other', drinks were noted to be taken 'socially', and drugs came under 'never' or 'sometimes'. The educational background ranged from 'working on college/university' to 'graduated from masters program'. Income data ranged from 20000 to 80000 and included some missing values (-1). The location data was all Bay Area specific: 'south san francisco', 'oakland', 'berkeley'. Other features in the dataset included personal preferences such as offspring ('doesn't have kids, but might want them'), pets ('likes dogs and likes cats'), religion, sign. Data also included essay responses describing self-presentations and interests of users, though those were mostly cut off in this display: essay0-essay2.
...
Interesting insights are drawn from the analysis of drug usage patterns across education levels. As shown in the visualization, the highest drug users were from the 'completed college/university' category at 1,641 users, closely followed by the 'still working on college/university' users at 685 users. For instance, individuals who dropped out of colleges, universities, and law schools had the most conservative patterns of drug use. This analysis therefore shows that completion of higher education, especially college/university level, corresponds with higher reported use of drugs, while discontinued education is associated with more conservative usage. These findings set an important context in which the association between educational attainment and drug use behaviors can be understood in the dating profile data.
