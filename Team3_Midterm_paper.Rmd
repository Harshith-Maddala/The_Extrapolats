...
Our analysis of the pattern of drug usage by education level is quite illustrative. As clearly denoted in the visualization, the group that reported completing college/university had the highest disposition towards the use of drugs, with 1,641 users. This then follows those currently working towards their college/university education, with 685 users. Of interest, the most conservative patterns of drug use were found among those subjects who had dropped out from colleges, universities, and law schools. Further analysis may thus reveal that completion of higher education, especially college/university level, is positively correlated with higher reported drug use, 
